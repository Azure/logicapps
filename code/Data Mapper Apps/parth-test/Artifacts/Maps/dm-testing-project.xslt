        ...
        <ns0:PROJECT_REQUEST_ROOT>
          <ns0:PROJECT_REQUEST>
            <ns0:INTEGRATION_HEADER>
              ...
              <ns0:RequestedOperation>{/ns4:projectGBO/OEBS_Header/messageDetails/requestedOperation}</ns0:RequestedOperation>
            ...
            <ns0:PROJINTRF>
              <xsl:for-each select="/ns4:projectGBO/project">
                <ns0:PROJECT>
                  ...
                  <ns0:CUSTOMERS>
                    <ns0:CUSTOMER>
                      <ns0:ALLOW_INV_USER_RATE_TYPE_FLAG>{concat(/ns4:projectGBO/OEBS_Header/messageDetails/user, /ns4:projectGBO/OEBS_Header/messageDetails/organisationUnit)}</ns0:ALLOW_INV_USER_RATE_TYPE_FLAG>
                    </ns0:CUSTOMER>
                  </ns0:CUSTOMERS>
                </ns0:PROJECT>
              </xsl:for-each>
