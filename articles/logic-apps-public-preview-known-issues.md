...
Public preview is now available in all regions where the Logic Apps service is available. Previously, public preview was available only in limited specific regions.
