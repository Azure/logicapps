namespace TestCases
{
    ...
    public class TestCases
    {
        ...
        public void RequestResponse()
        {
            ...
            using (new FunctionTestHost(new FunctionTestInput[] { new FunctionTestInput(workflowName, workflowDefinition) }))
        ...
        public void HttpAction()
        {
            ...
            using (new FunctionTestHost(new FunctionTestInput[] { new FunctionTestInput(workflowName, workflowDefinition) }, localSettings: localSettings))
            ...
            var mockedResourceGroups = @"
{
    ""value"": [   
        ...
        },
        {
            ...
            using (new FunctionTestHost(new FunctionTestInput[] { new FunctionTestInput(workflowName, workflowDefinition) }, localSettings: localSettings, connectionDetails: connections))
            using (var host = new MockHttpHost())
            using (var client = new HttpClient())
            {
                // Configure mocked response.
