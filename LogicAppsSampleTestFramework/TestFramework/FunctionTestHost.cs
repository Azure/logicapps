namespace TestFramework
{
    ...
    /// </summary>
    public class FunctionTestHost : IDisposable
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FunctionTestHost"/> class.
        /// </summary>
        public FunctionTestHost(FunctionTestInput[] inputs = null, string localSettings = null, string parameters = null, string connectionDetails = null, string host = null, DirectoryInfo artifactsDirectory = null)
        {
        ...
        /// </summary>
        protected void StartFunctionRuntime(FunctionTestInput[] inputs, string localSettings, string parameters, string connectionDetails, string host, DirectoryInfo artifactsDirectory)
        {
            try
            {
                ...
                if (artifactsDirectory != null)
                {
                    ...
                    FunctionTestHost.CopyDirectory(source: artifactsDirectory, destination: new DirectoryInfo(artifactsWorkingDirectory));
                }
                ...
                {
                    throw new InvalidOperationException($"runtime did not start properly {errorData}");
                }
